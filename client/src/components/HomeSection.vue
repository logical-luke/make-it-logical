...
onMounted(() => {
  ...
  img.src = new URL('../assets/hero-image-1920x1080.webp', import.meta.url).href;
});

const emits = defineEmits(['hero-image-loaded']);

const onImageLoad = () => {
  imageLoaded.value = true;
  emits('hero-image-loaded');
};
</script>
...
<template>
  <section id="home" class="py-20 md:py-32 relative overflow-hidden">
    ...
    <div v-if="imageLoaded" class="relative z-10 md:w-1/2 lg:w-3/5">
