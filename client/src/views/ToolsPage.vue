...
const groupedTechnologies = computed(() => {
  const groups = {
    ...
    "Cloud and Infrastructure": ["AWS", "GCP", "On-Premise Infrastructure"],
    "Development Workflow and Collaboration": ["GitHub Actions", "Git"],
    "Performance and Security": ["Cloudflare"],
    ...
    "Artificial Intelligence and Automation": ["OpenAI", "Claude"],
  };
