...
<template>
  <div class="flex flex-col gap-24">
    <section class="min-h-[calc(100vh-80px)] flex flex-col md:flex-row">
      <div class="w-full md:w-1/2 mb-8 md:mb-0">
        <BottomToTopSlideTransition duration="300">
          <h1 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
            {{ t("We Deliver Software") }}<br>
            {{ t("You Enjoy Clarity") }}
          </h1>
          <h2 class="flex flex-col text-2xl md:text-3xl lg:text-4xl leading-tight">
            <span class="font-normal"><span class="text-primary font-semibold">{{ t("Simplified") }}</span> {{ t("Web") }}</span>
            <span class="font-normal">{{ t("Humanity") }} <span class="text-primary font-semibold">{{ t("Amplified") }}</span></span>
          </h2>
        </BottomToTopSlideTransition>
      </div>
      <div class="w-full md:w-1/2 mt-10 md:mt-0 md:mt-0 -ml-8">
        <BulbShape />
      </div>
    </section>
