  ...
  <section v-if="texts" class="about-page">
    ...
    <BottomToTopSlideTransition>
      <div class="mt-12 md:mt-16">
        <h2 class="mb-6 max-w-4xl text-2xl md:text-3xl font-bold text-gray-500 dark:text-gray-400">{{ texts.approach.title }}</h2>
    ...
    <BottomToTopSlideTransition>
      <div class="mt-12 md:mt-16">
        <h2 class="mb-6 max-w-4xl text-2xl md:text-3xl font-bold text-gray-500 dark:text-gray-400">{{ texts.whyChooseUs.title }}</h2>
