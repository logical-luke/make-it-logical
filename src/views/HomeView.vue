          ...
          <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            <div class="max-w-xl">
              <span class="text-lg font-extrabold text-indigo-500"
                >Simplifying the Web, Together</span
              >
              <h1 class="text-3xl md:text-4xl font-extrabold font-heading mt-3 mb-3">
                Tell Us Your Vision
              </h1>
              <p class="text-xl font-extrabold leading-8">
                Have an idea for an easy-to-use web app? Tell us about it! At Make IT Logical, we
                bridge tech and human insights to bring your goals to life as an intuitive online
                experience for everyone.
              </p>
            </div>
          </div>
          <div class="w-full lg:w-1/2 px-4">
            <div class="flex flex-wrap items-center lg:justify-end"></div>
          </div>
        </div>
        <div class="flex flex-wrap -mx-4 mb-16 items-center">
          <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
            <div class="flex flex-wrap -mx-4">
              <div class="w-full sm:w-1/2 px-4 mb-12">
                <div
                ...
                <p class="text-xl sm:text-2xl font-bold text-gray-400">contact@makeitlogical.io</p>
              </div>
